...
class Handler(BaseHTTPRequestHandler):
 ...
 def do_GET(self):
  # Public endpoints intentionally precede dashboard authentication. /buy exposes
  # only static offers and hosted-checkout links; it exposes no internal GOX state.
