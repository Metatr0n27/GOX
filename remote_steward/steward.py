...
ALLOWED = {
    ...
    "revenue_engine_tests": [["bash", "-lc", "cd /var/lib/gox-steward/mailbox && PYTHONPATH=. python3 -m unittest core.test_revenue_engine -v"]],
    "revenue_engine_tick": [["bash", "-lc", "cd /var/lib/gox-steward/mailbox && PYTHONPATH=. python3 core/revenue_engine.py"]],
    "revenue_engine_status": [["bash", "-lc", "cat /var/lib/gox/revenue/latest_report.json 2>/dev/null || echo '{\"status\":\"no_report\"}'"]],
